...
@interface PopularViewController ()<NSFetchedResultsControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [SVProgressHUD show];
    [[DeviantArtApiHelper sharedHelper] browsePopular: nil success:^{
...
- (NSFetchedResultsController*)fetchedResultsController {
    ...
    NSFetchRequest *request = [NSFetchRequest fetchRequestWithEntityName:[PopularDeviation MR_entityName]];
