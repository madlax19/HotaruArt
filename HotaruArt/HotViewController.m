...
@interface HotViewController ()<NSFetchedResultsControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [SVProgressHUD show];
    [[DeviantArtApiHelper sharedHelper] browseHot: ^{
...
- (NSFetchedResultsController*)fetchedResultsController {
    ...
    NSFetchRequest *request = [NSFetchRequest fetchRequestWithEntityName:[HotDeviation MR_entityName]];
